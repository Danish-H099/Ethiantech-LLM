...
export default function CourseListPage() {
  ...
  const handleLevelChange = (value) =>
    startTransition(() => setLevel(value));
  const handleSortChange = (value) =>
    startTransition(() => setSortBy(value));

  const filterSignature = `${search}|${category}|${level}|${sortBy}`;
    ...
    <div className="relative min-h-screen bg-surface text-ink">
      ...
      <section className="bg-(image:--gradient-hero)">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-4 py-12 sm:px-6 sm:flex-row sm:items-center sm:py-16 lg:px-8 lg:py-16">
          <Motion.div variants={fadeUp} initial="hidden" animate="visible" className="text-left">
          ...
          <Motion.div variants={fadeUp} initial="hidden" animate="visible" className="w-full shrink-0 sm:w-auto sm:min-w-[320px]">
            ...
            {showFilters && (
              <AnimatePresence>
                <Motion.div
                  ...
                  exit="exit"
                  variants={slideUp}
                  className="card mb-6 p-5 lg:hidden"
                >
                      ...
                      {visibleCourses.map((course, i) => (
                        <Motion.div
                          ...
                          exit={{
                            opacity: 0,
                            scale: 0.96,
                            transition: { duration: 0.2, ease: easeDepart },
                          }}
                          custom={i}
                          className="h-full"
                        >
