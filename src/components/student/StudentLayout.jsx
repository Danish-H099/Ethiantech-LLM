  ...
  return (
    <div data-role="student" className="flex min-h-screen flex-col bg-surface font-outfit">
      ...
      <div className="flex flex-1">
        <aside
          ref={sidebarRef}
          className={`fixed inset-y-0 left-0 z-50 flex w-[200px] flex-col border-r border-gray-300 bg-white transition-[width,transform] duration-200 lg:relative lg:z-0 lg:translate-x-0 ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full"
          } ${collapsed ? "lg:w-[76px]" : "lg:w-[200px] lg:min-w-[76px] lg:shrink"}`}
        >
          ...
          {/* Mobile-only action panel — mirrors the desktop navbar's profile
              ...
              header's dropdown instead of a one-off "Hi Student!" block. */}
        ...
        <main
          id="main"
          className="flex-1 min-w-0 bg-surface p-6 lg:p-8"
        >
