      ...
      <main id="main" className="flex-1">
        <Breadcrumbs
          items={[
            ...
            course ? { label: course.title, link: `/course/${course.id}` } : null,
            { label: "Video" },
          ].filter(Boolean)}
        />
        ...
        <div className="lg:flex lg:gap-10">
          ...
          <aside className="w-full shrink-0 lg:w-[471px]">
            <CourseStructure sections={sections} courseId={course?.id} />
          </aside>
            ...
            {activeTab === "comments" && (
              <div className="mt-6">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="btn-brand btn-brand-flat px-6 py-2.5 text-sm"
                  >
                    Comment
                  </button>
                </form>
